package com.rosy.im.common.enums;
...
public enum ResponseStatusEnum {
    ...
    USER_ALREADY_EXIST_ERROR(5021, "该用户已存在，不可重复注册！"),
    USER_ISNOT_EXIST_ERROR(5023, "该用户不存在，请前往注册！"),
    WECHAT_NUM_ALREADY_MODIFIED_ERROR(5024, "微信号已被修改，请等待1年后再修改！"),
    CAN_NOT_ADD_SELF_FRIEND_ERROR(5025, "无法添加自己为好友！"),
    FRIEND_NOT_EXIST_ERROR(5026, "好友不存在！"),
    ...
    FILE_MAX_SIZE_8MB_ERROR(5133, "体验版仅支持8MB以下的文件上传！"),
    FILE_MAX_SIZE_100MB_ERROR(5134, "仅支持100MB大小以下的文件上传！"),
    ...
    USER_REGISTER_ERROR(518, "用户注册失败，请重试！"),
    ...
    SENTINEL_BLOCK_FLOW_LIMIT_ERROR(5801, "系统访问繁忙，请稍后再试！"),
